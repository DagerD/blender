...
void OUTLINER_OT_collection_reference_collection(struct wmOperatorType *ot);
void OUTLINER_OT_collection_dereference_collection(struct wmOperatorType *ot);
void OUTLINER_OT_collection_reference_object(struct wmOperatorType *ot);
void OUTLINER_OT_collection_dereference_object(struct wmOperatorType *ot);
